...
<div class="container-fluid">
  ...
  <ul class="nav navbar-nav">
			...
			<li >
				<a href="studenthome.jsp" class="top_link"><span>Home</span> </a>
			</li>
				...
				<li class="dropdown">
				<a href="#nogo22" id="services" class="dropdown-toggle" data-toggle="dropdown"> Success<span class="caret"></span></a>
					
				<ul class="dropdown-menu">

							<li>
								<a href="./careers.jsp">Career</a>
							</li>
							<li>
								<a href="./resumes.jsp">Resume</a>
							</li>
				</ul>
				...
				<li class="dropdown">
				<a href="#nogo22" id="services" class="dropdown-toggle" data-toggle="dropdown">Events<span class="caret"></span> </a>
				
				<ul class="dropdown-menu">

							<li>
								<a href="./insertevents.jsp">AddEvents</a>
							</li>
							<li>
								<a href="./ViewEventsAction">ViewEvents</a>
							</li>
				</ul>
